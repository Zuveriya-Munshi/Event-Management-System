...
echo "<table  >";
    ...
    echo "<form action=\"FaraskhanaRent_DeleteSave.php\" method=\"POST\">";
    echo "<tr><td><p>Faraskhana Code : 
</td><td><input type=\"text\" name=\"faraskhanaCode\" value={$row['FaraskhanaCode']}></p></td></tr>";
