<?php
  ...
  if($con)
  {
    ...
    echo "<table >";
    echo "<form action=\"SoundSysRent_EditSave.php\" method=\"POST\">";
    echo "<tr><td><p>Faraskhana Code : </td><td> <input type=\"text\" name=\"soundSysCode\" value={$row['soundsysCode']}></p></td></tr>";
