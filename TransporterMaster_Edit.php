...
echo "<marquee><h1 class=impact style='color:white;' ><b><i>MUSICAL EVENT MANAGEMENT SYSTEM</i></b></h1></marquee>";
    echo "<h3 style='color:white;'>Click to Edit Tarnsporter Details</h3>";
    if(mysql_num_rows($result)>0)
    {
       ...
       <a href='index2.html' > <input type='button' name='Button' class='button' value='Home' /></td></a>
          ...
          {
            echo "<tr>";
            echo "<td><a href=\"TransporterMaster_EditDetails.php?id={$row['Transporterid']}\">".$row['Transporterid']."</a></td>";
