<?php
  ...
  if($con)
  {
    ...
    $DsoundsysCode=$_REQUEST['id'];
    echo '<link rel="stylesheet" type="text/css" href="css.css" />';
    $result=mysqli_query($con,"SELECT * FROM soundsyrent WHERE BookingID LIKE '%$DsoundsysCode%'");
...
echo "<table  >";
    ...
    echo "<form action=\"SoundSysRent_DeleteSave.php\" method=\"POST\">";
    echo "<tr><td><p>Soundsystem Code : </td><td><input type=\"text\" name=\"soundSysCode\" value={$row['soundsysCode']}></p></td></tr>";
