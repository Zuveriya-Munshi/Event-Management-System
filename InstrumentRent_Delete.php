<?php
  ...
  if($con)
  {
    ...
    $result=mysqli_query($con,"SELECT * FROM instrumentrent");
    echo '<link rel="stylesheet" type="text/css" href="css.css" />';
    echo "<center>";
    echo "<marquee><h1 class=impact style='color:white;' ><b><i>MUSICAL EVENT MANAGEMENT SYSTEM</i></b></h1></marquee>";

    echo "<h3 style='color:white;'>Click to Delete Instrument Rent Details</h3>";
    if(mysqli_num_rows($result)>0)
    {
        ...
        {
            echo "<tr>";
            echo "<td><a href=\"InstrumentRent_DeleteDetails.php?id={$row['BookingID']}\">".$row['BookingID']."</a></td>";
